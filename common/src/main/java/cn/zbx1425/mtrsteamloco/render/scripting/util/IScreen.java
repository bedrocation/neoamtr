...
public interface IScreen {
    ...
    public static class WithTextrue extends Screen {
        ...
        public MouseScrolledFunction mouseScrolledFunction = (screen, p_94734_, p_94735_, p_94736_, p_94737_) -> false;
        ...
        @Override
        public boolean mouseScrolled(double p_94734_, double p_94735_, double p_94736_, double p_94737_) {
            boolean flag = false;
            try {
                flag = mouseScrolledFunction.mouseScrolled(this, p_94734_, p_94735_, p_94736_, p_94737_);
            } catch (Exception e) {
                print ("mouseScrolledFunction error: " + e.getMessage());
                e.printStackTrace();
            }
            return flag || super.mouseScrolled(p_94734_, p_94735_, p_94736_, p_94737_);
        }
        ...
        public interface MouseScrolledFunction {
            boolean mouseScrolled(WithTextrue screen, double p_94734_, double p_94735_, double p_94736_, double p_94737_);
        }
