...
public class CompoundCreatorScreen extends Screen {
    ...
    public static CompoundTag getTag() {
        ...
        return item.getOrDefault(net.minecraft.core.component.DataComponents.CUSTOM_DATA,
    ...
    public static void updateTag(Consumer<CompoundTag> modifier) {
        ...
        modifier.accept(tag);
        net.minecraft.world.item.component.CustomData.set(net.minecraft.core.component.DataComponents.CUSTOM_DATA, item, tag);
